...
@section("content")
    ...
    <form action="/control-panel/quick-facts/{{ $data['page_data']->id }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <textarea name="text_en" cols="30" required class="form-control form-control-user" rows="10" placeholder="text">{{ $data['page_data']->text_en }}</textarea>
        </div>
        <div class="form-group">
            <textarea name="text_es" cols="30" required class="form-control form-control-user" rows="10" placeholder="text">{{ $data['page_data']->text_es }}</textarea>
        </div>
        <div class="form-group">
