            ...
            <div class="col-sm-7">
                <section v-for="(video, i) in data">
                    ...
                    <div class="social-row">
                        ...
                        <div class="fb-share-button" :data-href="baseUrl + '/spread-the-world/#share' + i" data-layout="button_count" data-size="small"><a target="_blank" :href="'https://www.facebook.com/sharer/sharer.php?u='+baseUrl+'/spread-the-world/#share'+i+'&amp;src=sdkpreparse'" class="fb-xfbml-parse-ignore"><img src="/site/images/fb-icon.png" alt="icon"></a></div>
